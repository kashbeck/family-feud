...
var app = {
  ...
  jsonLoaded: function(data){
    ...
    function toggleQuestion() {
      var opacity = question.css("opacity") || 1;
      opacity = opacity == 1 ? 0 : 1;
      question.css("opacity", opacity);
    }
  ...
  makeQuestion: function(qNum){
    ...
    var qAnswr = app.allData[qText];
		var qTextDecoded = qText.replace(/&x22;/gi,'"');
    ...
    question.html(qTextDecoded).css("opacity", 0);
    col1.empty();
    col2.empty();
    ...
    function showCard() {
  	...
  	window.opener.GetQuestion(qTextDecoded);
